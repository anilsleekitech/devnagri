...
const Govt = () => {
  ...
  return (
    <>
      <SEO
        title="Government Translation Solution | Devnagri"
                    ...
                    <div className="carousel-item active">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/leading-indito-an-bank-transforms-document-translation-workflow-with-ocr-and-automation"
                            className="white"
                          >
                    ...
                    <div className="carousel-item">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/prestigious-to-tech-institute-of-india-delivers-video-lectures-4x-faster-in-multiple-languages"
                            className="white"
                          >
                            <button type="btn" className="devnagri-btn mt-5">
                              View Case Studies
                    ...
                    <div className="carousel-item">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/devnagri-ai-to-empowered-leading-nbfc-institution-with-ideal-document-translation-solutions"
                            className="white"
                          >
                            <button type="btn" className="devnagri-btn mt-5">
                              View Case Studies
                    ...
                    <div className="carousel-item">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/a-midsized-ito-ndian-b2c-company-realizes-regional-growth-through-multilingual-collateral-translation"
                            className="white"
                          >
                            <button type="btn" className="devnagri-btn mt-5">
                              View Case Studies
                    ...
                    <div className="carousel-item">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/a-governmentto--organization-trained-language-model-with-chinese-hindi-translation"
                            className="white"
                          >
                            <button type="btn" className="devnagri-btn mt-5">
                              View Case Studies
                    ...
                    <div className="carousel-item">
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <Link
                            to="/how-dota-is-to-revolutionizing-language-translation-in-the-digital-age"
                            className="white"
                          >
                            <button type="btn" className="devnagri-btn mt-5">
                              View Case Studies
